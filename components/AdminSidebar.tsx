    ...
    <aside className="w-64 bg-[#161616] border-r border-gray-800 flex flex-col h-screen hidden md:flex shrink-0">
      ...
      <div className="h-20 flex items-center px-6 border-b border-gray-800">
        <div className="flex items-center space-x-3">
          ...
          <span className="font-serif text-lg font-bold text-[#FDFBF7] tracking-wide">
            MadhurGram
          </span>
        </div>
      </div>
      ...
      <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <p className="px-2 text-[10px] uppercase tracking-widest text-gray-500 font-bold mb-4">
          Admin Console
        </p>
