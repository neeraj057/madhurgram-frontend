      ...
      {slides.map((slide, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute inset-0 h-full w-full">
              {slide.type === "video" ? (
                ...
                <img
                  ...
                  alt={slide.headline || "MadhurGram Custom Banner"}
                  className="h-full w-full object-cover object-center transition-opacity duration-700"
                />
              )}

              {/* Luxury Scrim Overlay - Only for non-custom slides */}
              {slide.type !== "custom" && (
            ...
            {slide.type === "custom" ? (
              <a href={slide.ctaLink} className="absolute inset-0 z-10 block h-full w-full" aria-label="Custom Banner Link">
                {/* Full clickable area, no text overlay */}
              </a>
            ) : (
