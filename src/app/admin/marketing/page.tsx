...
export default function AdminMarketingPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Enforce 5MB limit on frontend to prevent server overload
    ...
    try {
      ...
      // Hit our new Secure Admin Media API for image storage
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-500">
            ...
            {heroType === 'custom' && "Upload a 1920x800 design banner image. It acts as a clickable slide without text overlays."}
            {heroType === 'offer' && "Displays a custom promotional card layout over the sweets deal background image."}
          </p>
        </div>

        {/* Right side: Config input */}
